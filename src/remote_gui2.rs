            ...
            egui::TopBottomPanel::bottom("separator_bar")
                ...
                .show(ctx, |ui| {
                    ui.horizontal_centered(|ui| {
                        ...
                        // More/Hist indicator badge at fixed 400px from left
                        ...
                        if is_scrolled_back {
                            ...
                            let badge_text = format!("  Hist {}  ", count_str);
                            ui.add(egui::Button::new(
                                egui::RichText::new(badge_text).monospace().size(fs_badge).strong()
                                    .color(egui::Color32::WHITE))
                                .fill(theme.more_indicator_bg())
                                .rounding(egui::Rounding::same(4.0))
                            ...
                            let badge_text = format!("  More {}  ", count_str);
                            ui.add(egui::Button::new(
                                egui::RichText::new(badge_text).monospace().size(fs_badge).strong()
                                    .color(egui::Color32::WHITE))
                                .fill(theme.more_indicator_bg())
